 ...
 */
public class ForeignAdapter extends RecyclerView.Adapter<ForeignAdapter.theViewHolder> {
    ...
    public void onBindViewHolder(final theViewHolder holder, int position) {
        holder.foreignTv.setText(datas.getOther_destinations().get(position).getName());
        holder.foreignTv.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public int getItemCount() {
        return datas.getOther_destinations().size() ;
    }
    ...
    class theViewHolder extends RecyclerView.ViewHolder{
        ...
        public theViewHolder(View itemView) {
            super(itemView);
            foreignTv = (Button) itemView.findViewById(R.id.foreign_item);
        }
    }
}
