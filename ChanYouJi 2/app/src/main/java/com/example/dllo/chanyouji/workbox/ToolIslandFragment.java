 ...
 */
public class ToolIslandFragment extends BaseFragment {
    private ExpandableListView listView;
    private ArrayList<ToolForeginBean> datas;
    private ToolInslanAdapter adapter;
    @Override
    public int setLayout() {
        return R.layout.tool_island_fragment;
    }

    @Override
    public void initView(View view) {
        listView = (ExpandableListView) view.findViewById(R.id.tool_insland_listview);
        adapter = new ToolInslanAdapter(context);
        datas = new ArrayList<>();
    }
